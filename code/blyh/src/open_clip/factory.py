...
def create_model(
        ...
        weights_only: bool = True,
        is_continual: bool = False, # If True, convert model to continual learning variant (adds projector)
        **model_kwargs,
) -> torch.nn.Module:
    """
    ...
    Args:
        ...
        is_continual: If True, convert model to continual learning variant (adds projector).
    ...
    vision_cfg["is_continual"] = is_continual
